...
func _show_ending(ending_type: String):
	...
	if (ending_type == "lost"): #all bases destroyed
		$CanvasLayer/ColorRect/Label.text = "You have fought valiantly, but but it has been for naught...
		...
		You prepare to launch your last rocket, but it is already too late.
